...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apontamentos', function (Blueprint $table) {
            ...
            $table->dateTime('apo_dthrinireal')->nullable();
            $table->dateTime('apo_dthrfim');
            $table->dateTime('apo_dthrfimreal')->nullable();
            $table->integer('apo_osproc_os_id');
            $table->integer('apo_osproc_seq');
            $table->string('apo_loc_lat')->nullable();
            $table->string('apo_loc_long')->nullable();
            $table->dateTime('apo_loc_dthr')->nullable();
